package com.isolate.application.service.file;
...
import com.isolate.domain.service.cache.CacheService;
import com.isolate.infrastructure.general.config.ConfigConstants;
import com.isolate.infrastructure.general.toolkit.KkFileUtils;
import com.isolate.domain.model.filePreview.FileType;
import com.isolate.domain.model.filePreview.FileAttribute;
import com.isolate.infrastructure.general.toolkit.WebUtils;
...
import static com.aspose.cad.Image.load;
...
public class FilePreviewHandler {
    ...
    private final Logger logger = LoggerFactory.getLogger(FilePreviewHandler.class);
    ...
    public boolean cadToPdf(String inputFilePath, String outputFilePath)  {
        Image cadImage = load(inputFilePath);
